...
export default class Toprated extends Component {
  ...
  _pressRow(rowData , rowID,sectionID,params){
      params.navigator.navigate('Movie' , { name : this.state.movielist[sectionID] , data :  this.state.apidata , id : sectionID });
  }
  ...
  getdata(){
    movielist = [];
    fetch(
      'https://api.themoviedb.org/3/movie/top_rated?api_key=830ab4aeaedf01193752b0fdfab97d5e&language=en-US&page=1'
    )
        ...
        <ListView
          ...
          renderRow={(rowData,rowID,sectionID,highlightRow) => (
            <View style = {styles.card}>
              <TouchableNativeFeedback
                onPress={() => this._pressRow(rowData,rowID,sectionID,params)}
